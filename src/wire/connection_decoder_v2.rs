...
use crate::{crypto::HeaderSecret, wire::varint::Varint};
...
bitflags! {
    pub struct TrafficFlags: u8 {
        const IS_CONNECTION = 0b00000001;
...
impl ConnectionDecoderV2 {
    ...
    pub fn traffic_frame(
        ...
        let connection_id = if flags.contains(TrafficFlags::IS_CONNECTION) {
    ...
    fn decode_stream_data_frame(
        ...
        let stream_id = if traffic_frame.flags.contains(TrafficFlags::IS_CONNECTION) {
    ...
    fn decode_end_of_stream_frame(
        ...
        if !traffic_frame.flags.contains(TrafficFlags::IS_CONNECTION) {
